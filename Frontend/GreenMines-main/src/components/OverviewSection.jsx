...
export default function OverviewSection() {
  ...
  // Calculate derived values, capping neutralityProgress at 100%
  const gap = totalEmissions - totalAbsorption;
  const rawNeutralityProgress = totalEmissions > 0 ? (totalAbsorption / totalEmissions) * 100 : 0;
  const neutralityProgress = Math.min(rawNeutralityProgress, 100); // Cap at 100%
  ...
  // Function to calculate CO2 sum (unchanged)
  ...
  // Calculate date range (unchanged)
